...
cond = EC.presence_of_element_located((By.XPATH, '//*[@id="rejected-papers-opted-in-public"]/ul/li[1]/h4/a[1]'))
...
for page in tqdm(range(1, 5)):
    text = ''
    elems = driver.find_elements("xpath", '//*[@id="rejected-papers-opted-in-public"]/ul/li')
    ...
    # next page
    try:
        driver.find_element('xpath', '//*[@id="rejected-papers-opted-in-public"]/nav/ul/li[7]/a').click()
